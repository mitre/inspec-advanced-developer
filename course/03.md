...
In the [first course](https://mitre.github.io/inspec-developer/course/05.html), we wrote, ran, and analyzed results of an InSpec profile made up of controls. Let's recap this process by practicing another control.
